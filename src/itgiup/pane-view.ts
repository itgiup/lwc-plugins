...
import { ItgiuplwcpluginsPaneRenderer } from './pane-renderer';
...
export class ItgiuplwcpluginsPaneView implements IPrimitivePaneView {
	_source: ItgiuplwcpluginsDataSource;
	_p1: ViewPoint = { x: null, y: null };
	_p2: ViewPoint = { x: null, y: null };

	constructor(source: ItgiuplwcpluginsDataSource) {
		this._source = source;
	}
	...
	renderer() {
		return new ItgiuplwcpluginsPaneRenderer(
			this._p1,
			this._p2,
