...
import { Point, PricerangesDataSource } from './data-source';

abstract class PricerangesAxisView implements ISeriesPrimitiveAxisView {
	_source: PricerangesDataSource;
	_p: Point;
	_pos: Coordinate | null = null;
	constructor(source: PricerangesDataSource, p: Point) {
		this._source = source;
		this._p = p;
	}
...
export class PricerangesTimeAxisView extends PricerangesAxisView {
	update() {
...
export class PricerangesPriceAxisView extends PricerangesAxisView {
	update() {
